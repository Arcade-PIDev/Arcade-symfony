 ...
 */
final class Version20230307175537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, lieu VARCHAR(255) NOT NULL, date_debut_e DATETIME NOT NULL, date_fin_e DATETIME NOT NULL, affiche_e VARCHAR(255) DEFAULT NULL, prix_ticket DOUBLE PRECISION NOT NULL, nbr_places INT NOT NULL, description_event VARCHAR(2000) DEFAULT NULL, nom_event VARCHAR(255) NOT NULL, all_day TINYINT(1) NOT NULL, background_color VARCHAR(7) NOT NULL, border_color VARCHAR(7) NOT NULL, text_color VARCHAR(7) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE history_record (id INT AUTO_INCREMENT NOT NULL, entity_name VARCHAR(255) NOT NULL, deleted_entity_id INT NOT NULL, deleted_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE history_record');
