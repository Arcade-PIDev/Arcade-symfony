...
class ParticipationsController extends AbstractController
{
    ...
    public function ajouterParticipations(Environment $twig,Request $request,EntityManagerInterface $manager)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $Participations->setUsers($this->getUser());
    ...
    public function exportData()
    {
        ...
        $worksheet->setCellValue('F1', 'Titre de la séance de coaching');
        ...
        foreach ($participations as $participation) {
            ...
            $worksheet->setCellValue('F' . $rowNumber, $participation->getIdseancefk()->getTitreSeance());
            $rowNumber++;
        }
